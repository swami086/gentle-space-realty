...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      assign_inquiry: {
        Args: { agent_id: string; inquiry_id: string; notes_text?: string }
        Returns: boolean
      }
      check_admin_access: {
      ...
      cleanup_inactive_users: {
        Args: { p_admin_user_id?: string; p_days_inactive?: number }
        Returns: {
      ...
      get_analytics_data: {
        Args: { end_date?: string; metrics?: string[]; start_date?: string }
        Returns: {
      ...
      save_property: {
        Args: { p_notes?: string; p_property_id: string; p_user_id: string }
        Returns: string
      }
      search_properties: {
        Args:
      ...
      update_inquiry_status: {
        Args: { inquiry_id: string; new_status: string; notes_text?: string }
        Returns: boolean
      }
      update_user_role: {
        Args: { p_admin_user_id: string; p_new_role: string; p_user_id: string }
        Returns: {
          email: string
          id: string
          name: string
